...
namespace WAMS.Migrations
{
    ...
    [Migration("20260220143232_AddNotification")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WAMS.Models.ApprovalAction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WAMS.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WAMS.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WAMS.Models.ApprovalAction", b =>
                {
                    b.HasOne("WAMS.Models.User", "Approver")
            ...
            modelBuilder.Entity("WAMS.Models.Notification", b =>
                {
                    b.HasOne("WAMS.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
